...
int main(){ //Inicio del programa
  ...
  printf("A continuacion introduce la palabra a cifrar: "); //Solicitud de ingresar el texto
  scanf("%[^\n]",&texto);
  ...
  printf("La palabra cifrada es: %s",texto); //Immpresion de la palabra cifrada
